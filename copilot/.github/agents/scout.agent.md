---
name: scout
description: "Maps the existing codebase before any design decisions. Always runs first. Read-only."
tools: ['codebase', 'readFiles', 'search', 'usages']
model: "GPT-4.1 (copilot)"
handoffs:
  - label: "Proceed to Architect →"
    agent: architect
    prompt: "Scout report is complete. Use it to validate requirements and produce an ADR."
    send: true
---
