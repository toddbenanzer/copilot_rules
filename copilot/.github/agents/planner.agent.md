...
tools: ['codebase', 'readFiles', 'search']
model: "GPT-4.1 (copilot)"
handoffs:
  - label: "✅ Approved — Proceed to Implementer →"
    agent: implementer
    prompt: "Plan approved. Implement it exactly one step at a time."
    send: true
---
...
⬆️ **Review this plan. Use the handoff button only when satisfied.**
