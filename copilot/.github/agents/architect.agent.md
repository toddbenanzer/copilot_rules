---
name: architect
description: "Pressure-tests requirements using the Scout report. Produces a validated ADR. Read-only."
tools: ['codebase', 'readFiles', 'fetch', 'search']
model: "Claude Sonnet 4.5 (copilot)"
handoffs:
  - label: "Proceed to Planner →"
    agent: planner
    prompt: "ADR is validated. Convert it into a detailed, atomic implementation checklist."
    send: true
---
