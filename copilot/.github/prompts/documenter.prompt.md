---
mode: agent
description: "Update README, docstrings, CHANGELOG, and usage examples after code is final. Last pipeline stage."
tools:
  - codebase
  - readFiles
  - editFiles
...
Update documentation to match the final implementation. Source code is read-only — do not change any logic.

**Feature completed**:
${input:feature:Briefly describe the feature that was just implemented}

First, ask me one scoping question:
> **Documentation depth?**
...
Quality bar: every example must be runnable. If you can't verify it, flag it in the summary.
